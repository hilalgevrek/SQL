...
-- Veritabaný geliþtirilirken product ve sale olmak üzere iki tane þema oluþturulmuþ
...
SELECT B.product_id, B.product_name, A.*  --  A.* dediðimiz için A tablosundaki tüm sütunlarý döndürdü 
FROM product.stock A
RIGHT JOIN product.product B ON A.product_id = B.product_id
WHERE B.product_id >310


-- Hangi tabloyu left ya da right join yapmak istiyorsam left join ya da right join yazdýktan sonra o tablonun ismini yazmalýyým
